...
- 💫 Main languages are [**TypeScript**](https://www.typescriptlang.org), [**JavaScript**](https://developer.mozilla.org/en-US/docs/Web/JavaScript) and [**PHP**](https://www.php.net/docs.php)
